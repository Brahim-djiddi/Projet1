...
<div class="container">
              ...
              <div class="card shadow-sm">
                <div class="card-body">
                  <nav class="nav flex-column nav-pills nav-gap-y-1">
                    <a href="_profile.php" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded">
                    ...
                    <a href="_securite.php" data-toggle="tab" class="nav-item nav-link has-icon nav-link-faded active">
              ...
              <div class="card shadow-sm">
                <div class="card-header border-bottom mb-3 d-flex d-md-none">
                  <ul class="nav nav-tabs card-header-tabs nav-gap-x-1" role="tablist">
                    ...
                    <li class="nav-item">
                      <a href="_profile.php" data-toggle="tab" class="nav-link has-icon "><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg></a>
                    </li>

                    <li class="nav-item">
                      <a href="change_pwd.php" data-toggle="tab" class="nav-link has-icon active"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shield"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg></a>
                    </li>
        ...
        <!--   profile card -->
            ...
            <div class="card-body tab-content shadow-sm">
              <div class="tab-pane active" id="profile">
               
            
                  <div class="card">
                  <div class="tab-pane" id="security">
                <h6>CHANGEMENT DU MOTS DE PASSE</h6>
                <hr>
                <form method="post" id="form-validation" novalidate>
                  <div class="form-group">
                    <label class="d-block">Mot de passe</label>
                    <input type="text" name="old_pwd"  class="form-control mt-3" placeholder="Entrer votre ancien mot de passe" required>
                    <input type="text" name="new_pwd" class="form-control mt-3" placeholder="Entrer un nouveau mot de passe" required>
                    <input type="text" name="conf_pwd" class="form-control mt-3" placeholder="Confirmer le nouveau mot de passe" required>
                    <hr>
                    <input type="submit" class="btn btn-sm btn-dark" value="Changer">
                  </div>
                </form>
                <hr>
            </div>
