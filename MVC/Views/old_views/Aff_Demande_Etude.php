            ...
            <tbody>
                <?php foreach ($variables["AFF"] as $AD) { ?>
                    <tr>
                        ...
                        <td><a class="btn btn-sm btn-success" href="index.php?action=supprimer_pdf&id=<?php echo $AD['Link']; ?>" >modifier</a></td>
                        <td><a class="btn btn-sm btn-success" href="index.php?action=modifier_pdf&id=<?php echo $AD['Link']; ?>" >supprimer</a></td>
